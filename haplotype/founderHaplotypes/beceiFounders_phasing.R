...
source("~/Documents/Documents - MacBook Pro de tom/rockmanlab/cbecei_haplo/functions_beceiFounders_phasing.R")
rils <- read_csv("~/Documents/Documents - MacBook Pro de tom/rockmanlab/genotypeTables/becei_chr_V_Cross_AB_Founder_RIL_GT_table.csv")
#####################################
...
###phasedfounderhaplotypes = phasedfounderhaplotypes[-(30752:30764),]
...
# 
# save(phasedfounderhaplotypes, file="~/Documents/Documents - MacBook Pro de tom/rockmanlab/cbecei_haplo/240515_beceiFounderPhasedHaplotypes_chrV.Rdata")
